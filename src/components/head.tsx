...
export const Head = (props: Props) => (
  <>
    ...
    <meta name="description" content={props.description ?? defaultProps.description} />
    <link rel="canonical" href="https://deepso.sh" />

    <meta property="og:title" content={props.title ?? defaultProps.title} />
    <meta property="og:description" content={props.description ?? defaultProps.description} />
    ...
    <meta name="twitter:image" content={props.ogImage ?? defaultProps.ogImage} />
